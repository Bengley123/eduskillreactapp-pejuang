    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <form className="space-y-5">
          ...
          {/* Kolom Jumlah Lulusan yang Sudah Bekerja */}
          <div>
            <label className="block font-medium text-gray-700 mb-1">
            ...
            <input
              type="number"
              name="lulusanKerja"
              value={formData.lulusanKerja}
              onChange={handleChange}
              className="w-full px-4 py-2 border rounded"
              placeholder="Masukkan jumlah lulusan bekerja"
            />
          </div>

          {/* Kolom Jumlah Pendaftar */}
          <div>
            <label className="block font-medium text-gray-700 mb-1">
              Jumlah Pendaftar
            </label>
          ...
          {/* Kolom Pelatihan yang Sedang Dibuka */}
          <div>
            <label className="block font-medium text-gray-700 mb-1">
            ...
            <input
              type="text"
              name="pelatihanAktif"
              value={formData.pelatihanAktif}
              onChange={handleChange}
              className="w-full px-4 py-2 border rounded"
              placeholder="Contoh: Pelatihan Desain Grafis, Web Development"
            />
          </div>
