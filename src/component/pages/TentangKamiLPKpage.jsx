...
export default function TentangKamiLPKPage() {
  return (
    <div className="min-h-screen bg-gray-100 pt-8 pb-16 px-4">
      <TentangKamiContent
        title="Lembaga Pelatihan dan Kursus Bina ESSA"
        image={logo}
        alt="Logo Bina Essa"
        description={
          <>
            <span className="font-bold">LPK Bina Essa Bandung</span> adalah lembaga pelatihan kerja yang berkomitmen mencetak sumber daya manusia unggul dan siap kerja melalui pendidikan vokasi berkualitas. 
